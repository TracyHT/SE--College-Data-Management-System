...
export default function Pass(){
    ...
    return(
    <div className = "mt-6 h-32 flex w-[384px] py-[24px] px-[24px] dark:bg-[#6c757d] bg-white justify-center  rounded-[20px] gap-[20px]">
                        <div className = "text-center mt-5">
                            <h1 className = "text-black dark:text-white text-2xl font-bold text-center mt-0.5">Password</h1> 
                        </div>
